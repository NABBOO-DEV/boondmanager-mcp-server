...
export function registerPurchaseTools(server) {
    server.registerTool("boond_purchases_search", {
...
Returns: Liste des achats correspondants.`,
        ...
        return {
            content: [{ type: "text", text: formatListResponse(response, "achat") }],
        };
    });
    server.registerTool("boond_purchases_get", {
    ...
    server.registerTool("boond_purchases_create", {
    ...
    registerDeleteTool(server, { entityName: "achat", entityNamePlural: "achats", apiPath: "/purchases", prefix: "boond_purchases" }, {
