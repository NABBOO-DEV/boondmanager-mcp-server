...
export function registerPlanningAbsenceTools(server) {
    server.registerTool("boond_planning_absences_search", {
...
Returns: Planning des absences.`,
        ...
        return {
            content: [{ type: "text", text: formatListResponse(response, "planning absence") }],
        };
    });
}
//# sourceMappingURL=planning-absences.js.map