...
const ProviderInvoiceCreateSchema = z
    ...
    .strict();
export function registerProviderInvoiceTools(server) {
    server.registerTool("boond_provider_invoices_create", {
        ...
        if (companyId)
            relationships.providerCompany = { data: { id: companyId, type: "company" } };
        if (contactId)
            relationships.providerContact = { data: { id: contactId, type: "contact" } };
    ...
    server.registerTool("boond_provider_invoices_search", {
        ...
        return {
            content: [{ type: "text", text: formatListResponse(response, "facture fournisseur") }],
        };
    });
    server.registerTool("boond_provider_invoices_get", {
...
//# sourceMappingURL=provider-invoices.js.map