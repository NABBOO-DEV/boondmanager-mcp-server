...
export function registerNotificationTools(server) {
    server.registerTool("boond_notifications_search", {
...
Returns: Liste des notifications correspondantes.`,
        ...
        return {
            content: [{ type: "text", text: formatListResponse(response, "notification") }],
        };
    });
    server.registerTool("boond_notifications_get", {
