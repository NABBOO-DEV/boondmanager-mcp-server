...
export function registerDeliveryTools(server) {
    server.registerTool("boond_deliveries_create", {
    ...
    server.registerTool("boond_deliveries_search", {
...
Returns: Liste des livraisons correspondantes.`,
        ...
        return {
            content: [{ type: "text", text: formatListResponse(response, "livraison") }],
        };
    });
    server.registerTool("boond_deliveries_get", {
